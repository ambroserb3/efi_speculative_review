...
def create_dataframe(metadata_dir, text_dir):
    ...
    :param metadata_dir: The directory containing metadata files.
    :param text_dir: The directory containing text files.
    :return: A DataFrame containing metadata for each book.
    """
    data = []
